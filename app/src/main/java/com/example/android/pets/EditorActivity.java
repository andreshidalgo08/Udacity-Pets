            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.gender_male))) {
                        mGender = PetEntity.GENDER_MALE; // Male
                    } else if (selection.equals(getString(R.string.gender_female))) {
                        mGender = PetEntity.GENDER_FEMALE; // Female
                    } else {
                        mGender = PetEntity.GENDER_UNKNOWN; // Unknown
                    }
                }
            }
    ...
    private void showDeleteConfirmationDialog() {
        ...
        builder.setPositiveButton(R.string.delete, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                petsViewModel.deletePet(editPet);
                Toast.makeText(EditorActivity.this, "Pet deleted.", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
